...
describe("swNFT", async() => {
  const pubkey = "0xa5e7f4a06080b860d376871ce0798aa7677e7a4b117a5bd0909f15fee02f28a62388496982c133fef1eba087d8a06005";
  const withdrawal_credentials = "0x00479ca39024528497e333bceed04026a3b6573846c7c449e5a5ef26dfe7fde1";
  const signature = "0x81786c544c8746d274d292e2decb634165f36641e51d3cd9ea022c27591e5fd6d5cb25072df96b9d4b06ecf4766f7682140ba5e618506c79539799953d9a273f1b7663e30a34dbc33010bac8ccda26341113b26fe26d639a616d106241745f8a";
  const deposit_data_root="0xcf55433ed2ceb04c0d96780245339bea1af9ec60c946c11b4c01f297b7140cd9"
  ...
  it("can emit LogState", async function(){
    expect(swNFT.stake(
      ...
      deposit_data_root,
      "28899",
      {value: ethers.utils.parseEther("1")})).to.emit(swNFT, "LogStake")
  ...
  it("can stake more than 1 ether", async function() {
    ...
    expect(tokenURI).to.be.equal("https://raw.githubusercontent.com/leckylao/Eth2S/main/metaData/28899/1000000000000000000.json");

    const token = await swNFT.tokens('1')
    expect(token.pubKey).to.be.equal("0xa5e7f4a06080b860d376871ce0798aa7677e7a4b117a5bd0909f15fee02f28a62388496982c133fef1eba087d8a06005");
